...
#if (COMMAND logic_add_std_ovl OR NOT STD_OVL_FOUND)
#    return()
#endif()

include(LogicAddModule)

function(logic_add_std_ovl)
    set(STD_OVL_SOURCES
        ovl_always.v
    ...
    foreach (source ${STD_OVL_SOURCES})
        logic_add_module(${STD_OVL_DIR}/${source}
            DEFINES
                OVL_VERILOG
                OVL_ASSERT_ON
                OVL_SVA_INTERFACE
            ...
            VERILATOR_CONFIGURATIONS
                "coverage_off -file \"${STD_OVL_DIR}/${source}\""
                "lint_off -msg WIDTH -file \"${STD_OVL_DIR}/${source}\""
